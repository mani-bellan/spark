...
spark.conf.set('temporaryGcsBucket', 'dataproc-temp-us-central1-82597348015-fdamwp60')

df_green_taxi = spark.read.parquet(input_green)
...
df_yellow_taxi = spark.read.parquet(input_yellow)
